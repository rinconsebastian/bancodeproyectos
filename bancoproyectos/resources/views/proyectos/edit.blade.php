                ...
                <form action="{{ route('proyectos.update', $proyecto) }}" method="POST">
                    ...
                    <div class="-mx-3 md:flex mb-6">
                        <div class="md:w-full px-3 mb-6 md:mb-0">
                            ...
                            <input
                                ...
                                id="name" name="name" type="text" value='{{ $proyecto->name }}'
                    ...
                    <div class="-mx-3 md:flex mb-6">
                        <div class="md:w-1/2 px-3 h-10">
                            <label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2"
                                for="fuente">
                                Fuente de Financiación {{ $proyecto->fuente }}
                            </label>
                            <select x-cloak style="display:none "
                                class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3"
                                value="{{ $proyecto->fuente }}" name="fuente1" id="select">
                                <option {{ str_contains($proyecto->fuente,'Propios') ? 'selected' : '' }} value="Propios">Propios
                                </option>
                            ...
                            <div x-data="dropdown()" x-init="loadOptions()"
                                ...
                                <input name="fuente" type="hidden" x-bind:value="selectedValues()">
                                            ...
                                            <div class="my-0 py-2 flex border border-gray-200 bg-white rounded">
                                                <div class="flex flex-auto flex-wrap">
                                                    ...
                                                    <div x-show="selected.length == 0" class="flex-1">
                                                        <input placeholder="Seleccione al menos una fuente"
                    ...
                    <div class="-mx-3 md:flex mb-2">
                        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <select
                                ...
                                <option {{ $proyecto->fase == 'II Prefactibilidad' ? 'selected' : '' }}
                                    value="II Prefactibilidad">II Prefactibilidad</option>
                                <option {{ $proyecto->fase == 'III Factibilidad' ? 'selected' : '' }}
                            ...
                            <div class="relative">
                                <select
                                    ...
                                    @foreach ($sectores as $sector)
                                        ...
                                        <option {{ $proyecto->sector == $sector ? 'selected' : '' }}
                        ...
                        loadOptions() {
                            ...
                            for (let i = 0; i < options.length; i++) {
                                this.options.push({
                                    ...
                                    selected: options[i].selected != null ? options[i].selected : false,
