...
<head>
    ...
    <meta property="og:image" content="https://tailwindcomponents.com/storage/3891/conversions/temp52362-ogimage.jpg?v=2021-07-23 12:21:45" />
...
<div x-data="setup()" :class="{ 'dark': isDark }">
    <div class="min-h-screen h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
