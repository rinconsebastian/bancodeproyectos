                            ...
                            <div class="block" id="tab-profile">
                                <div class="grid grid-cols-1 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12  p-0 gap-0">
                                    ...
                                    <div class="md:col-span-9 lg:col-span-10 xl:col-span-11 ">
                                        ...
                                        <div class="grid grid-cols-2 md:grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 p-0 gap-0 my-5">
                                            ...
                                            <div class="grid items-center mt-4 text-gray-600 dark:text-gray-400">
                                                ...
                                                <span class=" text-md tracking-normal text-center font-semibold w-100">Duración </span>
                                                    <span class="text-md  tracking-normal text-center font-semibold w-100">{{ $proyecto->tiempo }} meses </span>
                                            ...
                                            <div class="grid items-center mt-4 text-gray-600 dark:text-gray-400">
                                                ...
                                                <span class="text-md  tracking-normal text-center font-semibold w-full">Valor</span>
                                                    <span class=" tracking-normal text-center">${{ number_format($proyecto->valor, 2, ',', '.') }}</span>
                                            ...
                                            <div class="grid items-center mt-4 text-gray-600 dark:text-gray-400">
                                                ...
                                                <span class="text-md  tracking-normal text-center font-semibold w-full">Sector</span>
                                                   <span class=" tracking-normal text-center">{{ $proyecto->sector }}</span> 
                                            ...
                                            <div class="grid items-center mt-4 text-gray-600 dark:text-gray-400">
                                                ...
                                                <span class=" text-md  tracking-normal text-center font-semibold w-full">Fuente delos recursos</span>
                                                   <span class=" tracking-normal text-center">{{ $proyecto->fuente }}</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class=" grid right-0 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-1 p-0 gap-0 alig">
        ...
        if (id != null) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.livewire.emit("transicion", id, accion);
