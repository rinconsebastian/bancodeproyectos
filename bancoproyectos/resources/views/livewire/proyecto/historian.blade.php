<div>
    ...
    <div x-data="{animate:{{$open}}}" class="border " >

        <div @click="animate = (animate) ? false : true"
            class="cursor-pointer  grid grid-cols-1 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 bg-gray-200 hover:bg-gray-300 dark:bg-gray-800 sm:rounded-lg mr-2  p-3  "
            >
        ...
        <div x-show="animate" 
            ...
            class=" border border-b-0 px-10 py-6 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 p-4 gap-4 text-black dark:text-white pt-1" >
